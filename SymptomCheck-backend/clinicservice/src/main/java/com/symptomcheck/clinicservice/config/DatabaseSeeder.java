...
public class DatabaseSeeder implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
         ...
         if (medicalClinicRepository.findAll().isEmpty()) {
           ...
           List<MedicalClinic> b =   medicalClinicRepository.saveAll(clinics);
           if (b.isEmpty()) {
               log.info("No medical clinic found");
           }
           else  {
               log.info("Medical clinic found *******************");
           }
